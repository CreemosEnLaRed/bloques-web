...
Blockly.Blocks['bs_card_body'] = {
  init: function() {
    ...
    this.appendStatementInput("ITEMS")
        .setCheck(null);
    this.setPreviousStatement(true, "bs_card_body");
    this.setNextStatement(true, "bs_card_body");
    this.setColour(230);
 this.setTooltip("");
 this.setHelpUrl("");
  }
...
Blockly.Blocks['bs_card_image'] = {
  init: function() {
    ...
    this.setPreviousStatement(true, "bs_card_image");
    this.setNextStatement(true, "bs_card_image");
    this.setColour(230);
 this.setTooltip("");
 this.setHelpUrl("");
  }
