...
Blockly.Blocks['html_tag'] = {
  init: function() {
    this.appendValueInput("ATTRS")
        .setCheck(null)
        .appendField(new Blockly.FieldDropdown([["p","p"], ["h1","h1"], ["h2","h2"], ["h3","h3"], ["h4","h4"], ["h5","h5"], ["h6","h6"], ["strong","strong"], ["em","em"], ["span","span"], ["div","div"], ["img","img"], ["a","a"], ["hr","hr"], ["ol","ol"], ["ul","ul"], ["li","li"], ["nav","nav"], ["button","button"], ["table","table"], ["thead","thead"], ["tbody","tbody"], ["tr","tr"], ["td","td"]]), "TAG");
    this.appendStatementInput("ITEMS")
        .setCheck(null);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
...
Blockly.Blocks['html_attr_class'] = {
  init: function() {
